...
const newFn = `export async function generateProductDescription(req, res, next) {
  try {
    ...
    const systemPrompt = "You are a premium human e-commerce copywriter for Aura Rudraksha. You must output ONLY the final product description. Do NOT output any reasoning, planning, or thought process. DO NOT write \\"Here is your description\\", just write the description.";
...
console.log("Patched auraAiController.js with system prompt");
