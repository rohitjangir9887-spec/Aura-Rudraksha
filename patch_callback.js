...
// Replace handlePayuCallback hash check
...
// Replace the status !== "success" failure logic to include hash mismatch
content = content.replace(
  /\/\/ 6\. If status is NOT success, record failure and redirect cleanly[\s\S]*?\/\/ 7\. Perform Server-to-Server Verification/m,
  `// 6. If status is NOT success, or hash mismatched on a non-success
