export const defaultProducts = [
  {
    ...
    name: "Original 14 Mukhi Rudraksha (Nepali) — Lab Certified Chaudah Mukhi Deva Mani",
    price: 36950,
    comparePrice: 59000,
    mrp: 59000,
    rating: 5.0,
  ...
  },
  {
    ...
    name: "1 Mukhi Rudraksha (Nepali) — Lab Certified Ek Mukhi Supreme Bead",
    price: 3499,
    comparePrice: 4999,
    mrp: 4999,
    rating: 4.9,
  ...
  },
  {
    ...
    name: "2 Mukhi Rudraksha (Nepali) — Do Mukhi Ardhanarishvara Bead",
    price: 1199,
    comparePrice: 1799,
    mrp: 1799,
    rating: 4.8,
    ...
    origin: "Nepali",
    highlight: "Symbolizes Lord Ardhanarishvara representing emotional unity, marital harmony, and inner peace. Calms Chandra Dosha.",
    tags: ["Marital Harmony", "Emotional Stability", "Chandra Dosha Shanti", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 35,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "3 Mukhi Rudraksha (Nepali) — Teen Mukhi Agni Swaroop Bead",
    price: 1099,
    comparePrice: 1699,
    mrp: 1699,
    rating: 4.8,
    ...
    badge: "Vitality & Confidence",
    mukhi: "3 Mukhi",
    deity: "Lord Agni Dev & Mangal",
    rulingPlanet: "Mars (Mangal)",
    origin: "Nepali",
    highlight: "Blessed by Lord Agni to burn past negative karmas, dissolve inferiority complex, and instill vigorous confidence.",
    tags: ["Agni Swaroop", "Past Karma Cleansing", "Dynamic Energy", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 40,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "4 Mukhi Rudraksha (Nepali) — Chaar Mukhi Brahma & Saraswati Bead",
    price: 1149,
    comparePrice: 1749,
    mrp: 1749,
    rating: 4.9,
    ...
    origin: "Nepali",
    highlight: "Represents Lord Brahma and Maa Saraswati. Boosts intellect, sharp vocal communication, and academic excellence.",
    tags: ["Intellect & Memory", "Communication Power", "Budh Dosha Shanti", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 45,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "5 Mukhi Rudraksha (Nepali) — Consecrated & Lab Certified Paanch Mukhi",
    price: 999,
    comparePrice: 1499,
    mrp: 1499,
    rating: 4.9,
  ...
  },
  {
    ...
    name: "6 Mukhi Rudraksha (Nepali) — Chhah Mukhi Lord Kartikeya Bead",
    price: 1199,
    comparePrice: 1799,
    mrp: 1799,
    rating: 4.8,
    ...
    origin: "Nepali",
    highlight: "Governed by Lord Kartikeya, the commander of divine armies. Grants willpower, supreme emotional balance, and charm.",
    tags: ["Lord Kartikeya Blessing", "Willpower & Stamina", "Shukra Harmonization", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 35,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "7 Mukhi Rudraksha (Nepali) — Saat Mukhi Goddess Mahalakshmi Bead",
    price: 1299,
    comparePrice: 1899,
    mrp: 1899,
    rating: 4.8,
    ...
    badge: "Auspicious Wealth",
    mukhi: "7 Mukhi",
    deity: "Goddess Mahalakshmi",
    rulingPlanet: "Saturn (Shani Dev)",
    origin: "Nepali",
    highlight: "Blessed by Goddess Mahalakshmi to attract abundance, career growth, and financial stability while alleviating Saturn obstacles.",
  ...
  },
  {
    ...
    name: "8 Mukhi Rudraksha (Nepali) — Aath Mukhi Lord Ganesha Bead",
    price: 1499,
    comparePrice: 2199,
    mrp: 2199,
    rating: 4.9,
    ...
    badge: "Obstacle Destroyer",
    mukhi: "8 Mukhi",
    deity: "Lord Ganesha (Vighnaharta)",
    rulingPlanet: "Rahu",
    origin: "Nepali",
    highlight: "Removes all impediments in business, legal matters, and life journeys. Brings wisdom, auspicious beginnings, and Rahu protection.",
    tags: ["Vighnaharta Ganesha", "Removes Impediments", "Rahu Shanti", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 30,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "9 Mukhi Rudraksha (Nepali) — Nau Mukhi Maa Durga Navadurga Bead",
    price: 1599,
    comparePrice: 2399,
    mrp: 2399,
    rating: 4.9,
    ...
    rulingPlanet: "Ketu",
    origin: "Nepali",
    highlight: "Infused with the 9 forms of Goddess Durga. Bestows fearlessness, spiritual endurance, protective shield, and Ketu mitigation.",
    tags: ["Navadurga Shakti", "Fearlessness & Protection", "Ketu Dosha Shanti", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 30,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "10 Mukhi Rudraksha (Nepali) — Das Mukhi Lord Vishnu Protection Bead",
    price: 1649,
    comparePrice: 2499,
    mrp: 2499,
    rating: 4.9,
    ...
    badge: "10 Directions Protection",
    mukhi: "10 Mukhi",
    deity: "Lord Vishnu (Dashavatar)",
    rulingPlanet: "All 9 Planets (Navagraha Shield)",
    origin: "Nepali",
    highlight: "Shields the wearer from negative influences in all 10 directions. Pacifies Navagraha disturbances and legal entanglements.",
    tags: ["Vishnu Protection", "Shields 10 Directions", "Navagraha Harmonizer", "Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 25,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "11 Mukhi Rudraksha (Nepali) — Ekadash Rudra Lord Hanuman Bead",
    price: 1699,
    comparePrice: 2499,
    mrp: 2499,
    rating: 4.9,
  ...
  },
  {
    ...
    name: "12 Mukhi Rudraksha (Nepali) — Barah Mukhi Surya Tejas Authority Bead",
    price: 1899,
    comparePrice: 2799,
    mrp: 2799,
    rating: 4.9,
    ...
    badge: "Solar Radiance",
    mukhi: "12 Mukhi",
    deity: "Lord Surya (12 Adityas)",
    rulingPlanet: "Sun (Surya Dev)",
    origin: "Nepali",
    highlight: "Conveys the radiant energy of the 12 Adityas. Bestows administrative leadership, radiant charisma, and career authority.",
    tags: ["12 Adityas Energy", "Charisma & Authority", "Surya Tejas", "Govt Lab Certified", "100% Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 25,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    origin: "Nepali",
    highlight: "Naturally joined twin bead symbolizing the divine cosmic union of Shiva and Shakti. The ultimate bead for family bliss and marital unity.",
    tags: ["Shiva Shakti Union", "Marital Bliss & Harmony", "Twin Conjoined Bead", "Lab Tested", "Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 20,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "Original Ganesh Rudraksha (Nepali) — Natural Trunk Shaped Sacred Bead",
    price: 2499,
    comparePrice: 3899,
    mrp: 3899,
    rating: 4.9,
    ...
    badge: "Lord Ganesha Trunk",
    mukhi: "Ganesh",
    deity: "Lord Ganesha",
    rulingPlanet: "Rahu & Ketu Harmonizer",
    origin: "Nepali",
    highlight: "Features a natural trunk-like elevation on the surface representing Lord Ganesha. Attracts success in all new ventures and studies.",
    tags: ["Natural Trunk Bead", "New Venture Success", "Vighnaharta Blessings", "Govt Lab Tested", "Nepali Origin"],
    category: "Rudraksha",
    status: "Active",
    stock: 25,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    name: "Sacred 108+1 Rudraksha Japa Mala — Silk Hand-Knotted Nepali Beads",
    price: 1899,
    comparePrice: 2999,
    mrp: 2999,
    rating: 4.9,
