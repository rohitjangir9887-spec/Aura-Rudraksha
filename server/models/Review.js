...
const reviewSchema = new mongoose.Schema(
  {
    ...
    source: { type: String, enum: ["customer", "google_reviews", "imported", "ai_draft", "ai_generated", "admin"], default: "customer", index: true },
...
nreviewSchema.index({ productId: 1, status: 1 });
