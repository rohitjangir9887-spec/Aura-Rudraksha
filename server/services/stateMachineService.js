...
const ALLOWED_PAYMENT_TRANSITIONS = {
  [PAYMENT_STATES.PENDING]: [PAYMENT_STATES.PAID, PAYMENT_STATES.FAILED, PAYMENT_STATES.REVIEW, PAYMENT_STATES.NOT_RECEIVED, PAYMENT_STATES.UNPAID, PAYMENT_STATES.CANCELLED],
  [PAYMENT_STATES.FAILED]: [PAYMENT_STATES.PENDING, PAYMENT_STATES.PAID, PAYMENT_STATES.NOT_RECEIVED, PAYMENT_STATES.UNPAID, PAYMENT_STATES.CANCELLED],
  [PAYMENT_STATES.CANCELLED]: [PAYMENT_STATES.PENDING, PAYMENT_STATES.PAID],
  [PAYMENT_STATES.NOT_RECEIVED]: [PAYMENT_STATES.PENDING, PAYMENT_STATES.PAID],
  [PAYMENT_STATES.UNPAID]: [PAYMENT_STATES.PENDING, PAYMENT_STATES.PAID],
  [PAYMENT_STATES.REVIEW]: [PAYMENT_STATES.PAID, PAYMENT_STATES.FAILED, PAYMENT_STATES.NOT_RECEIVED],
  [PAYMENT_STATES.PAID]: [PAYMENT_STATES.REFUND_PENDING, PAYMENT_STATES.PARTIALLY_REFUNDED, PAYMENT_STATES.REFUNDED],
  [PAYMENT_STATES.REFUND_PENDING]: [PAYMENT_STATES.PAID, PAYMENT_STATES.PARTIALLY_REFUNDED, PAYMENT_STATES.REFUNDED],
