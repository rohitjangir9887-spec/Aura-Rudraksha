...
const ALLOWED_PAYMENT_TRANSITIONS = {
  [PAYMENT_STATES.PENDING]: [PAYMENT_STATES.PAID, PAYMENT_STATES.FAILED, PAYMENT_STATES.REVIEW, PAYMENT_STATES.NOT_RECEIVED, PAYMENT_STATES.UNPAID],
  [PAYMENT_STATES.FAILED]: [PAYMENT_STATES.PENDING, PAYMENT_STATES.PAID, PAYMENT_STATES.NOT_RECEIVED, PAYMENT_STATES.UNPAID],
