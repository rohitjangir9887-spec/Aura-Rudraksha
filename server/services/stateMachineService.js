...
const ALLOWED_PAYMENT_TRANSITIONS = {
  ...
  [PAYMENT_STATES.REVIEW]: [PAYMENT_STATES.PAID, PAYMENT_STATES.FAILED, PAYMENT_STATES.REFUNDED],
  [PAYMENT_STATES.PAID]: [PAYMENT_STATES.REFUND_PENDING, PAYMENT_STATES.PARTIALLY_REFUNDED, PAYMENT_STATES.REFUNDED],
  [PAYMENT_STATES.REFUND_PENDING]: [PAYMENT_STATES.PARTIALLY_REFUNDED, PAYMENT_STATES.REFUNDED, PAYMENT_STATES.PAID],
...
const ALLOWED_ORDER_TRANSITIONS = {
  [ORDER_STATES.PAYMENT_PENDING]: [ORDER_STATES.CONFIRMED, ORDER_STATES.PROCESSING, ORDER_STATES.CANCELLED],
  [ORDER_STATES.PENDING]: [ORDER_STATES.CONFIRMED, ORDER_STATES.PROCESSING, ORDER_STATES.CANCELLED],
  ...
  [ORDER_STATES.SHIPPED]: [ORDER_STATES.OUT_FOR_DELIVERY, ORDER_STATES.DELIVERED],
