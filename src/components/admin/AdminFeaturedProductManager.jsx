...
export function AdminFeaturedProductManager({ products = [], onSettingsSaved }) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "12px", borderBottom: "1px solid #f0ebe4", paddingBottom: "14px", marginBottom: "16px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <div style={{ background: "#fed7aa", color: "#7c2d12", padding: "5px", borderRadius: "8px", display: "flex" }}>
              <Star size={18} />
            </div>
            <h2 style={{ fontSize: "16px", fontWeight: "700", color: "#2b170d", margin: 0 }}>
              Home Featured Product (Promotional Ad)
            </h2>
          </div>
          <p style={{ margin: "4px 0 0", fontSize: "12.5px", color: "#7a6a5e" }}>
        ...
        >
          {enabled && selectedProduct ? "● Active on Home" : "○ Disabled"}
        </span>
      </div>
