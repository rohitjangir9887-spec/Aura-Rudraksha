...
export function ProductInfoTabs({ product, reviewsCount = 0, averageRating = "5.0" }) {
  ...
  const renderDescription = (text) => {
    ...
    // 🛡️ SECURITY: Always sanitize fallback HTML strings before passing them to dangerouslySetInnerHTML
    // Even if the main path checks for HTML tags, malicious input could bypass the check and inject scripts.
