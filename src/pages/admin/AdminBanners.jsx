...
export function AdminBanners() {
  return (
    <AdminLayout>
      <Link to={ADMIN_BASE_PATH} className="admin-back-link">
      ...
      <div className="admin-card" style={{padding: 0}}>
        ...
        <Link to={`${ADMIN_BASE_PATH}/categories`} style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px', textDecoration: 'none', color: '#3b322c', borderBottom: '1px solid #f0ebe4'}}>
          <div>
        ...
        <Link to={`${ADMIN_BASE_PATH}/banners/promotions`} style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px', textDecoration: 'none', color: '#3b322c'}}>
          <div>
